...
const {middleware,middlewareCSRF,middlewareCSRFparaTodasViews} = require("./src/middlewares/middleware")
...
app.use(csrf())
app.use(middleware,middlewareCSRF,middlewareCSRFparaTodasViews)
app.use(routes);
app.on('to pronto',()=>{
  app.listen(port, () => {
